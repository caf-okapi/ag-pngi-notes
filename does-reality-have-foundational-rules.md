# Does Reality Have Foundational Rules?
...
In the first option, reality is determined by axioms, laws, principles, or constraints that are taken as fundamental. Various ideas consider mathematical, physical, and/or conceptual possibilities, which function as governing structures that determine what is possible and what is not, but which are also, necessarily, not explained by any deeper rules themselves.

In the second option, however, there are no axiom-like rules at the bottom. Reality does not bottom out in a fixed set of governing principles. If stable structures, regularities, or identities exist under this option, they must be able to do so without being mandated by any foundational rules.

These are, more or less, the two possibilities.

These notes seek to explore the possibilities of option two, and to suggest how, possibly, a reality could exist and function with no foundational governance. They explore the possibility that reality does not rest on foundational governing rules, and ask what forms of structure, persistence, and explanation might still be available under that assumption.
